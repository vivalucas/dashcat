...
enum Language: String, CaseIterable {
    ...
    private static let table: [String: [String: String]] = [
        ...
        "display":       ["zh":"显示",      "zh-TW":"顯示",    "en":"Display",           "ja":"表示",                "ko":"표시",           "de":"Anzeige",                     "fr":"Affichage",              "es":"Pantalla",               "pt-BR":"Exibição",            "it":"Visualizzazione",       "ru":"Отображение"],
        ...
        "pin":          ["zh":"固定",       "zh-TW":"固定",     "en":"Pin",             "ja":"ピン",                 "ko":"고정",              "de":"Anheften",                    "fr":"Épingler",               "es":"Fijar",                  "pt-BR":"Fixar",               "it":"Fissa",                  "ru":"Закрепить"],
        "unpin":        ["zh":"取消固定",   "zh-TW":"取消固定", "en":"Unpin",           "ja":"ピン解除",             "ko":"고정 해제",         "de":"Lösen",                       "fr":"Détacher",               "es":"Desfijar",               "pt-BR":"Desafixar",           "it":"Rimuovi",                "ru":"Открепить"],
        ...
        "launchLogin":  ["zh":"开机启动",   "zh-TW":"開機啟動", "en":"Launch at Login",  "ja":"ログイン時に起動",     "ko":"로그인 시 시작","de":"Beim Login starten",          "fr":"Lancer au démarrage",    "es":"Iniciar al arrancar",    "pt-BR":"Iniciar no login",    "it":"Avvia al login",         "ru":"Запуск при входе"],
